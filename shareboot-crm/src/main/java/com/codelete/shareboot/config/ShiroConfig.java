package com.codelete.shareboot.config;
...
import com.codelete.shareboot.cache.RedisCacheManager;
import com.codelete.shareboot.realm.CustomerCredentialsMatcher;
import com.codelete.shareboot.realm.MemberRealm;
import com.codelete.shareboot.session.RedisSessionDAO;
...
public class ShiroConfig {
	...
	public RememberMeManager getRememberManager() { // 5
		...
		SimpleCookie cookie = new SimpleCookie("shareboot-RememberMe");
	...
	public DefaultWebSessionManager getSessionManager(SessionDAO sessionDAO,
		...
		SimpleCookie sessionIdCookie = new SimpleCookie("share-session-id");
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
		...
		shiroFilterFactoryBean.setSuccessUrl("/druid"); // 设置跳转成功页
